...
<meta name="description" content="<?= $list['tag'] ?>">
...
<meta property="og:description" content="<?= $list['tag'] ?>">
...
<meta name="twitter:title" content="<?= $list['tag'] ?>">
<meta name="twitter:description" content="<?= $list['tag'] ?>">
<meta name="twitter:image" content="">
<meta name="twitter:image:src" content="">
<!-- E:tweeter card -->
<meta name="content_PublishedDate" content="">
<meta name="content_Category" content="<?= $list['tag'] ?>">
...
<div class="container">
    <ul class="breadcrumb bg-transparent m-0 p-0">
        ...
        <li class="breadcrumb-item">
            <a href="<?= site_url('tag') ?>" class="content_center">Tag</a>
        </li>
        <li class="breadcrumb-item active">
            <a href="<?= $list['url'] ?>" class="content_center" alt="<?= $list['tag'] ?>"><?= $list['tag'] ?></a>
        </li>
    </ul>
</div>
<!-- Breadcrumb End -->
